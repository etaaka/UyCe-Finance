    ...
    const dutyBodyTemplate = (rowData: Partnership) => {
        return (
            <>
                ...
                <MultiSelect value={rowData.duties} options={PartnershipService.getDuties(t)} disabled={true}
                             readOnly={true}
            ...
            <div className='grid p-fluid mt-3'>
                ...
                <span className='p-float-label'>
                    <Dropdown id='seniorManagementType' value={partnership.seniorManagementType}
                              ...
                              placeholder={t('partnership.selectSeniorManagementType')} display='chip'
                              optionLabel='name' optionValue='code'
                              onChange={(e) => onInputChange(e, 'seniorManagementType')}
                ...
                <span className='p-float-label'>
                    <Dropdown id='education' value={partnership.education}
                              ...
                              placeholder={t('partnership.selectEducation')} display='chip'
                              optionLabel='name' optionValue='code'
                              onChange={(e) => onInputChange(e, 'education')}
                ...
                <span className='p-float-label'>
                    <Dropdown id='boardOfDirectorType' value={partnership.boardOfDirectorType}
                              ...
                              placeholder={t('partnership.selectBoardOfDirectorType')} display='chip'
                              optionLabel='name' optionValue='code'
                ...
                <div className='field col-12 md:col-6'>
                <span className='p-float-label'>
                    <InputMask id='fax' mask='(999) 999-9999' value={partnership.contact.faxNo}
